...
```
/Users/KS/.openclaw/workspace/.agents/skills/huashu-nuwa/examples/[person-name]-perspective/
├── SKILL.md  # 最终产物
...
#### Step 4: 输出
将完成的SKILL.md写入 `/Users/KS/.openclaw/workspace/.agents/skills/huashu-nuwa/examples/[person-name]-perspective/SKILL.md`。

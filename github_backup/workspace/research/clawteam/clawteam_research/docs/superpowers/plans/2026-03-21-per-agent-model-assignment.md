...
**Spec:** `docs/superpowers/specs/[SENSITIVE_TOKEN_HARD_REDACTED].md`
...
Run: `cd ~/Projects/ClawTeam-OpenClaw && python -m pytest tests/test_spawn_backends.py::[SENSITIVE_TOKEN_HARD_REDACTED] tests/test_spawn_backends.py::[SENSITIVE_TOKEN_HARD_REDACTED] -v`

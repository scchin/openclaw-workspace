...
class TestSendReceive:
    ...
    def [SENSITIVE_TOKEN_HARD_REDACTED](self, team_name):
...
class TestReceiveQuarantine:
    def [SENSITIVE_TOKEN_HARD_REDACTED]_valid_message(self, team_name):
        mb = _make_mailbox(team_name)
    ...
    def [SENSITIVE_TOKEN_HARD_REDACTED]_first(self, team_name):
        mb = _make_mailbox(team_name)
        inbox = _inbox_path(team_name, "bob")
    ...
    def [SENSITIVE_TOKEN_HARD_REDACTED]_behavior(self, team_name):
...
class TestFileTransport:
    ...
    def [SENSITIVE_TOKEN_HARD_REDACTED](self, team_name, monkeypatch):
        transport = FileTransport(team_name)
...
class TestP2PLease:
    ...
    def [SENSITIVE_TOKEN_HARD_REDACTED]_alive(self, team_name):
        from clawteam.transport.p2p import P2PTransport

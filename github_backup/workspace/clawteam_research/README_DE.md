...
<p align="center">
  <strong>[SENSITIVE_TOKEN_HARD_REDACTED] für CLI-Coding-Agenten — <a href="https://openclaw.ai">OpenClaw</a> als Standard</strong>
</p>
...
- **Modellzuweisung pro Agent** (Vorschau): verschiedene Modelle für verschiedene Rollen zuweisen — siehe [unten](#[SENSITIVE_TOKEN_HARD_REDACTED])

...
function isModuleNotFoundError(err) {
	...
	return record !== null && (record.code === "ERR_MODULE_NOT_FOUND" || record.code === "MODULE_NOT_FOUND");
}
function hasGaxiosConstructorShape(value) {
	return typeof value === "function" && "prototype" in value && asNullableObjectRecord(value.prototype) !== null && typeof value.prototype._defaultAdapter === "function";
}
...
async function loadGaxiosConstructor() {
	...
	try {
		const candidate = asNullableObjectRecord(await import(pathToFileURL(createRequire(import.meta.url).resolve("gaxios")).href))?.Gaxios;

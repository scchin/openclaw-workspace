...
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-Dvv9VRAc.js";
...
import { o as resolveGatewayInstallEntrypoint } from "./daemon-install-plan.shared-BosiTjSa.js";
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-BWDkLtoT.js";
import { r as runCommandWithTimeout } from "./exec-BAdwyfxI.js";
import { I as asResolvedSourceConfig, L as asRuntimeConfig, l as readConfigFileSnapshot } from "./io-5pxHCi7V.js";
import { o as quoteCmdScriptArg } from "./restart-stale-pids-HQYy2vGd.js";
import { r as resolveGatewayService } from "./service-DkbTemHA.js";
import { t as runDaemonInstall } from "./install-CUhZoJJ0.js";
import { r as replaceConfigFile } from "./config-Q9XZc_2I.js";
import { t as runDaemonRestart } from "./lifecycle-CKbsl_IO.js";
import { n as formatConfigIssueLines } from "./issue-format-EKtDEAmx.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-BZcHItfA.js";
import { o as trimLogTail } from "./restart-sentinel-vSI_SrJz.js";
import { r as formatDurationPrecise } from "./format-duration-D2oH-5yd.js";
import { n as stylePromptMessage } from "./prompt-style-BRivICXb.js";
...
import { d as formatUpdateChannelLabel, g as resolveUpdateChannelDisplay, h as resolveEffectiveUpdateChannel, i as fetchNpmTagVersion, m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus, u as channelToNpmTag } from "./update-check-D1kBnXD1.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-g3JSYGGm.js";
import { r as installCompletion } from "./completion-runtime-DqL_lmqj.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-nL01l-yw.js";
import { n as doctorCommand, t as selectStyled } from "./prompt-select-styled-rf05yZzB.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerByPresence, d as resolveExpectedInstalledVersionFromSpec, f as resolveGlobalInstallSpec, g as readPackageVersion, h as readPackageName, i as canResolveRegistryVersionForPackageTarget, l as detectGlobalInstallManagerForRoot, m as normalizePackageTagInput, o as collectInstalledGlobalPackageErrors, p as resolveGlobalInstallTarget, r as runGatewayUpdate, s as createGlobalInstallEnv, u as globalInstallArgs } from "./normalize-job-identity-BeFZDaOX.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DwwVHnuC.js";
...
async function updateCommand(opts) {
	...
	} else if (!pluginsUpdatedInFreshProcess) await runPostCorePluginUpdate({
		root: postUpdateRoot,
		channel,

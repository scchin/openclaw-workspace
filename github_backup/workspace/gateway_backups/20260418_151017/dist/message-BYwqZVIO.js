...
import { a as projectOutboundPayloadPlanForDelivery, n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-BNvlWd4P.js";
...
function loadMessageConfigRuntime() {
	messageConfigRuntimePromise ??= import("./message.config.runtime-DLJvac7F.js");
	return messageConfigRuntimePromise;
}
function loadMessageGatewayRuntime() {
	messageGatewayRuntimePromise ??= import("./message.gateway.runtime-CEEohoxV.js");

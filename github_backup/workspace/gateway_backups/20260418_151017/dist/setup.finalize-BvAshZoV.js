...
import { d as pathExists, m as resolveUserPath } from "./utils-D5DtWkEu.js";
...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-hhTlRYqM.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-D3GGnU7N.js";
...
import { n as listConfiguredWebSearchProviders } from "./runtime-BRxW-LBe.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-DTnf-7Tf.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-B-FfdZ4h.js";
...
import { t as runTui } from "./tui-CD9-89mO.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-R-ehG1uC.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-jQy6iV5o.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-jQy6iV5o.js");

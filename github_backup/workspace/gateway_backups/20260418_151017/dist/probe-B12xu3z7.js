...
import { l as isRecord, v as sleep } from "./utils-D5DtWkEu.js";
import { s as normalizeStringEntries } from "./string-normalization-xm3f27dv.js";
import { i as withFileLock$1 } from "./file-lock-ByJeCMLs.js";
...
import { C as isRevokedProxyError, I as readNestedString, S as formatUnknownError, _ as loadMSTeamsSdkWithAuth, b as classifyMSTeamsSendError, g as createMSTeamsTokenProvider, h as createMSTeamsAdapter, p as readAccessToken, v as buildUserAgent, x as formatMSTeamsSendErrorHint } from "./graph-users-DskbJ6I1.js";
...
async function probeMSTeams(cfg) {
	...
	try {
		...
		if (cfg?.delegatedAuth?.enabled) try {
			const { loadDelegatedTokens } = await import("./token---oXt4Ni.js");

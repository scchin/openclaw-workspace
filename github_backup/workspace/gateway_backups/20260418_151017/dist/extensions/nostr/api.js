...
import { n as nostrPlugin, r as publishNostrProfile, t as getNostrProfileState } from "./channel-D41Nh49_.js";
import { a as resolveNostrAccount, c as getNostrRuntime, f as NostrProfileSchema, l as setNostrRuntime, u as contentToProfile } from "./setup-surface-DBTsUXeT.js";
...
function validateUrlSafety(urlStr) {
	try {
		...
		if ((0, runtime_api_exports.isBlockedHostnameOrIp)(normalizeLowercaseStringOrEmpty(url.hostname))) return {
			ok: false,
...
const profileRateLimiter = (0, runtime_api_exports.createFixedWindowRateLimiter)({
	windowMs: 6e4,
	maxRequests: 5,
	maxTrackedKeys: 2048
});
...
async function readJsonBody(req, maxBytes = 64 * 1024, timeoutMs = 3e4) {
	const result = await (0, runtime_api_exports.readJsonBodyWithLimit)(req, {
		maxBytes,
		timeoutMs,
	...
	if (result.code === "REQUEST_BODY_TIMEOUT") throw new Error((0, runtime_api_exports.requestBodyErrorToText)("REQUEST_BODY_TIMEOUT"));
	if (result.code === "CONNECTION_CLOSED") throw new Error((0, runtime_api_exports.requestBodyErrorToText)("CONNECTION_CLOSED"));

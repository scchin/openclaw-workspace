import { a as setFeishuNamedAccountEnabled, i as feishuSetupAdapter, n as runFeishuLogin, t as feishuSetupWizard } from "./setup-surface-D6LvPm54.js";
import { a as isRecord$1 } from "./comment-shared-BhUvGfra.js";
import { a as createFeishuClient, c as inspectFeishuCredentials, d as resolveDefaultFeishuAccountId, f as resolveFeishuAccount, l as listEnabledFeishuAccounts, p as resolveFeishuRuntimeAccount, u as listFeishuAccountIds } from "./probe-DftphXPF.js";
import { a as jsonToolResult, c as createFeishuToolClient, l as resolveAnyEnabledFeishuToolsConfig, m as normalizeFeishuTarget, n as registerFeishuDriveTools, o as toolExecutionErrorResult, p as looksLikeFeishuId, s as unknownToolActionResult, u as resolveFeishuToolAccount } from "./drive-qXTyBlIh.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-DZXBlv3U.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-MY-s6hH3.js";
import { a as listFeishuDirectoryGroups, i as registerFeishuChatTools, o as listFeishuDirectoryPeers } from "./chat-ClPqfAgi.js";
import { n as messageActionTargetAliases, t as collectFeishuSecurityAuditFindings } from "./security-audit-Da5Zhl_5.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DIpADEx7.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-D92juXut.js";
import { t as getFeishuRuntime } from "./runtime-C8BytrqV.js";
import { n as createFeishuThreadBindingManager, r as getFeishuThreadBindingManager, t as __testing } from "./thread-bindings-Cns_pzNK.js";
import { describeAccountSnapshot } from "openclaw/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "openclaw/plugin-sdk/allow-from";
import { createActionGate, createMessageToolCardSchema } from "openclaw/plugin-sdk/channel-actions";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-MjnXAlrV.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		auth: { login: async ({ cfg }) => {
			...
			const { runFeishuLogin } = await import("./setup-surface-D6LvPm54.js").then((n) => n.r);
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-Bq9OdXVi.js");

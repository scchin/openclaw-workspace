...
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth } from "./config-CjEkxZYF.js";
import { n as LogService } from "./logger-C5fFucd6.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-dmxinV4R.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-CAWMMpr_.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));

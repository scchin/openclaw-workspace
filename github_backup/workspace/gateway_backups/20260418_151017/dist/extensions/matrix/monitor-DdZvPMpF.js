...
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-CjEkxZYF.js";
import { i as resolveMatrixStateFilePath } from "./storage-SlJEDkuD.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-B8C2wBWb.js";
import { D as resolveConfiguredAcpBindingRecord, E as resolveAllowlistProviderRuntimeGroupPolicy, M as resolveThreadBindingMaxAgeMsForChannel, O as resolveDefaultGroupPolicy, P as warnMissingProviderGroupPolicyFallbackOnce, T as resolveAgentIdFromSessionKey$1, d as getSessionBindingService$1, j as resolveThreadBindingIdleTimeoutMsForChannel, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-api-CvFdrnSv.js";
import { h as resolveMatrixAllowListMatch, m as normalizeMatrixUserId, p as normalizeMatrixAllowList } from "./exec-approvals-6lCjP2at.js";
import { t as isMatrixQualifiedUserId } from "./target-ids-SzOps7vq.js";
import { _ as toLocationContext, a as canonicalizeAllowlistWithResolvedIds, c as ensureConfiguredAcpBindingReady, d as getAgentScopedMediaLocalRoots, f as logInboundDrop, g as summarizeMapping, h as resolveAckReaction, i as buildAllowlistResolutionSummary, l as formatAllowlistMatchMeta, m as patchAllowlistUsersInConfigEntries, n as resolveMatrixRoomConfig, o as createReplyPrefixOptions, p as logTypingFailure, r as addAllowlistUserEntriesFromConfigEntry, s as createTypingCallbacks, t as resolveMatrixStoredSessionMeta, u as formatLocationText, v as matrixApprovalCapability } from "./session-store-metadata-C0LV12r1.js";
import { r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-DxFYl2Z6.js";
import { t as isBunRuntime } from "./runtime-BPhQDz3d.js";
import { n as LogService } from "./logger-C5fFucd6.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-dmxinV4R.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-Di_gEwBE.js";
import "./client-DqoFZ3x6.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-C8bX5g1T.js";
import { t as resolveMatrixTargets } from "./resolve-targets-DuKsiJul.js";
import { a as sendMessageMatrix, c as sendSingleTextMessageMatrix, g as isPollStartType, h as isPollEventType, i as reactMatrixMessage, l as sendTypingMatrix, n as editMessageMatrix, p as formatPollAsText, r as prepareMatrixSingleText, s as sendReadReceiptMatrix, t as chunkMatrixText, v as parsePollStartContent } from "./send-hDTRqif4.js";
import { d as MATRIX_REACTION_EVENT_TYPE, i as promoteMatrixDirectRoomCandidate, l as MsgType, m as extractMatrixReactionAnnotation, s as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY } from "./direct-management-BK42sApl.js";
...
import { t as createMatrixThreadBindingManager } from "./thread-bindings-6oG6neP0.js";
import { t as createAsyncLock } from "./async-lock-hEU0xcd9.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState, t as isMatrixDisconnectedSyncState } from "./sync-state-CYLq9dR6.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTarget } from "./approval-reactions-D0ti_DpW.js";
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-CQ90H56e.js";
import { n as setActiveMatrixClient } from "./active-client-CaJPILsr.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-BWUu_Ms2.js";
...
import { loadSessionStore, resolveChannelContextVisibilityMode, resolveSessionStoreEntry } from "openclaw/plugin-sdk/config-runtime";
import { buildAgentSessionKey, deriveLastRoutePolicy, resolveThreadSessionKeys } from "openclaw/plugin-sdk/routing";
import { readJsonFileWithFallback, writeJsonFileAtomically } from "openclaw/plugin-sdk/json-store";
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "openclaw/plugin-sdk/approval-handler-adapter-runtime";
import { format } from "node:util";
import { createDraftStreamLoop, waitUntilAbort } from "openclaw/plugin-sdk/channel-lifecycle";
...
function resolveMatrixMonitorAccessState(params) {
	...
	const effectiveAllowFrom = normalizeMatrixAllowList([...configuredAllowFrom, ...params.storeAllowFrom]);
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-BK42sApl.js").then((n) => n.t), import("./direct-room-Da_xiZDy.js").then((n) => n.t)]).then(([directManagementModule, directRoomModule]) => ({
...
function registerMatrixMonitorEvents(params) {
	const { cfg, client, auth, allowFrom, dmEnabled, dmPolicy, readStoreAllowFrom, directTracker, logVerboseMessage, warnedEncryptedRooms, warnedCryptoMissingRooms, logger, startupGraceMs, getHealthySyncSinceMs, formatNativeDependencyHint, onRoomMessage, runDetachedTask } = params;
...
function resolveMatrixInboundRoute(params) {
	...
	const runtimeBinding = getSessionBindingService$1().resolveByConversation({
		channel: "matrix",
		accountId: params.accountId,
	...
	if (runtimeBinding && boundSessionKey) return {
		route: {
			...
			agentId: resolveAgentIdFromSessionKey$1(boundSessionKey) || baseRoute.agentId,
	...
	const effectiveRoute = configuredBinding && configuredSessionKey ? {
		...
		agentId: resolveAgentIdFromSessionKey$1(configuredSessionKey) || configuredBinding.spec.agentId || baseRoute.agentId,
		lastRoutePolicy: deriveLastRoutePolicy({
			sessionKey: configuredSessionKey,
			mainSessionKey: baseRoute.mainSessionKey
		}),
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-CZrXhUGk.js").then((n) => n.t),
		import("./device-health-DLYx-XaL.js"),
		import("./profile-Dbxhp2Xk.js").then((n) => n.n),
		import("./legacy-crypto-restore-D-YWRb8w.js"),
		import("./startup-verification-B7Z5TZ6p.js")

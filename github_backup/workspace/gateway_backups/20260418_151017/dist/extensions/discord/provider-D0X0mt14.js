...
import { a as resolveDiscordModalEntry, i as resolveDiscordComponentEntry, t as editDiscordComponentMessage } from "./send.components-74kaqy38.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-BKG4KIVC.js";
import { F as validateDiscordProxyUrl, I as withValidatedDiscordProxy, L as chunkDiscordTextWithMode, N as createDiscordRequestClient, O as createDiscordRestClient, P as resolveDiscordProxyFetchForAccount } from "./send.shared-DIBQaUs5.js";
import { t as formatMention } from "./mentions-BJtDuuvX.js";
import { n as formatDiscordUserTag, t as formatDiscordReactionEmoji } from "./format-XDPCvGK4.js";
import { _ as shouldEmitDiscordReactionNotification, a as resolveDiscordAllowListMatch, c as resolveDiscordChannelPolicyCommandAuthorizer, d as resolveDiscordMemberAccessState, g as resolveGroupDmAllow, i as normalizeDiscordSlug, n as isDiscordGroupAllowedByPolicy, p as resolveDiscordOwnerAccess, r as normalizeDiscordAllowList, s as resolveDiscordChannelConfigWithFallback, u as resolveDiscordGuildEntry } from "./allow-list-MMNtJoJ7.js";
import { _ as parseDiscordModalCustomId, g as parseDiscordComponentCustomIdForCarbon, h as parseDiscordComponentCustomId, v as parseDiscordModalCustomIdForCarbon } from "./components-D-Smrfec.js";
import { a as isDiscordExecApprovalClientEnabled, r as getDiscordExecApprovalApprovers } from "./ui-BxLG13MU.js";
import "./approval-native-54PbSLKT.js";
import { n as resolveDiscordConversationIdentity } from "./media-detection-Cmvt7HIM.js";
import { a as isThreadArchived, d as formatThreadBindingDurationLabel } from "./thread-bindings.discord-api-CXU-VN5J.js";
import { t as fetchDiscordApplicationId } from "./probe-9b8bVbqv.js";
import { c as normalizeDiscordListenerTimeoutMs, l as runDiscordTaskWithTimeout } from "./timeouts-DFBGDirT.js";
import { i as resolveDiscordThreadParentInfo, u as resolveDiscordChannelInfo } from "./threading-rB6oooGZ.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-DouSdifA.js";
import { a as handleDiscordDmCommandDecision, c as buildDirectLabel, d as resolveDiscordSenderIdentity, i as resolveDiscordEffectiveRoute, l as buildGuildLabel, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, s as deliverDiscordReply } from "./route-resolution-BShArSf5.js";
import { t as authorizeDiscordVoiceIngress } from "./access-CJk9VIIB.js";
import "./approval-handler.runtime-DcgKwVjy.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-Cw759tJG.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-ibwFSQGY.js";
...
import { GROUP_POLICY_BLOCKED_LABEL, resolveDefaultGroupPolicy, resolveOpenProviderRuntimeGroupPolicy as resolveOpenProviderRuntimeGroupPolicy$1, warnMissingProviderGroupPolicyFallbackOnce } from "openclaw/plugin-sdk/runtime-group-policy";
...
import { readSessionUpdatedAt as readSessionUpdatedAt$1, resolveStorePath as resolveStorePath$1 } from "openclaw/plugin-sdk/session-store-runtime";
...
function resolveDiscordGuildNativeCommandAuthorized(params) {
	const { groupPolicy } = resolveOpenProviderRuntimeGroupPolicy$1({
...
async function ensureAgentComponentInteractionAllowed(params) {
	...
	if (!await ensureGuildComponentMemberAllowed({
		...
		groupPolicy: resolveOpenProviderRuntimeGroupPolicy$1({
...
async function loadConversationRuntime() {
	conversationRuntimePromise ??= import("./agent-components.runtime-BQIS_EOB.js");
	return await conversationRuntimePromise;
}
async function loadComponentsRuntime() {
	componentsRuntimePromise ??= import("./components-D-Smrfec.js").then((n) => n.a);
...
async function loadTypingRuntime() {
	typingRuntimePromise ??= import("./typing-YgMqya3F.js").then((n) => n.n);
	return await typingRuntimePromise;
}
function resolveComponentGroupPolicy(ctx) {
	return resolveOpenProviderRuntimeGroupPolicy$1({
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-B8AlmFPx.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-CRcnPbN7.js");

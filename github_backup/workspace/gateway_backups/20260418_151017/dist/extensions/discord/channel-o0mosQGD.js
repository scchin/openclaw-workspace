...
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-eS313RO2.js";
import { o as shouldSuppressLocalDiscordExecApprovalPrompt, t as DiscordUiContainer } from "./ui-BxLG13MU.js";
import { t as getDiscordApprovalCapability } from "./approval-native-54PbSLKT.js";
import { t as discordMessageActions$1 } from "./channel-actions-DLth3-zs.js";
import { r as resolveDiscordCurrentConversationIdentity, t as isLikelyDiscordVideoMedia } from "./media-detection-Cmvt7HIM.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-cPkC8d36.js";
...
import { t as getDiscordRuntime } from "./runtime-DT1yDtrK.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-gXrjj2uh.js";
import { n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-Cp4gA3Ad.js";
...
import { createOpenProviderConfiguredRouteWarningCollector, resolveToolsBySender } from "openclaw/plugin-sdk/channel-policy";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config--yWHiRvI.js").then((n) => n.t));
const loadDiscordSecurityAuditModule = createLazyRuntimeModule(() => import("./security-audit.runtime-BY1qX48p.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Cw759tJG.js").then((n) => n.n));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-ibwFSQGY.js").then((n) => n.n));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BfxhjvHf.js").then((n) => n.a));
const require = createRequire(import.meta.url);
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-BaxKpTq_.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-l2sVFgG5.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-Dn2mW9M5.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DrbFKdd7.js").then((n) => n.t);
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-Ck7PM0CG.js").then((n) => n.t);

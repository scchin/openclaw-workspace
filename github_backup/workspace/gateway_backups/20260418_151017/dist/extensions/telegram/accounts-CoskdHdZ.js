import { DEFAULT_ACCOUNT_ID, createAccountActionGate, listCombinedAccountIds, normalizeAccountId, normalizeOptionalAccountId, resolveAccountEntry, resolveAccountWithDefaultFallback, resolveListedDefaultAccountId, resolveNormalizedAccountEntry } from "openclaw/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "openclaw/plugin-sdk/channel-core";
import { resolveDefaultSecretProviderAlias } from "openclaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID as DEFAULT_ACCOUNT_ID$1, formatSetExplicitDefaultInstruction, listBoundAccountIds, normalizeAccountId as normalizeAccountId$1, resolveDefaultAgentBoundAccountId } from "openclaw/plugin-sdk/routing";
...
function resolveTelegramToken(cfg, opts = {}) {
	...
	const accountCfg = resolveAccountCfg(accountId !== DEFAULT_ACCOUNT_ID$1 ? accountId : DEFAULT_ACCOUNT_ID$1);
	if (accountId !== DEFAULT_ACCOUNT_ID$1 && !accountCfg) {
		const accounts = telegramCfg?.accounts;
	...
	const allowEnv = accountId === DEFAULT_ACCOUNT_ID$1;
...
function resolveDefaultTelegramAccountId(cfg) {
	...
	if (resolved !== ids[0] || ids.includes(DEFAULT_ACCOUNT_ID) || ids.length <= 1) return resolved;
...
//#endregion
export { resetMissingDefaultWarnFlag as a, resolveTelegramAccountConfig as c, resolveTelegramToken as d, mergeTelegramAccountConfig as i, resolveTelegramMediaRuntimeOptions as l, listEnabledTelegramAccounts as n, resolveDefaultTelegramAccountId as o, listTelegramAccountIds as r, resolveTelegramAccount as s, createTelegramActionGate as t, resolveTelegramPollActionGateState as u };

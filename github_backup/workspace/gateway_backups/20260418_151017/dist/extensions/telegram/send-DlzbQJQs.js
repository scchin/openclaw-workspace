...
import { a as normalizeTelegramChatId, o as normalizeTelegramLookupTarget, s as parseTelegramTarget, t as normalizeTelegramReplyToMessageId } from "./outbound-params-DPqRaEDE.js";
import { a as makeProxyFetch, n as resolveTelegramFetch } from "./fetch-B2K4ajFP.js";
import { a as splitTelegramHtmlChunks, b as buildTypingThreadParams, c as isSafeToRetrySendError, d as isTelegramRateLimitError, f as isTelegramServerError, i as renderTelegramHtmlText, s as isRecoverableTelegramNetworkError, y as buildTelegramThreadParams } from "./format-DkmJkZf4.js";
import { loadConfig, loadConfig as loadConfig$1, loadCronStore, readConfigFileSnapshotForWrite, resolveCronStorePath, resolveMarkdownTableMode, resolveStorePath, saveCronStore, writeConfigFile } from "openclaw/plugin-sdk/config-runtime";
import { normalizeLowercaseStringOrEmpty, normalizeOptionalString, redactSensitiveText } from "openclaw/plugin-sdk/text-runtime";
...
import { buildOutboundMediaLoadOptions as buildOutboundMediaLoadOptions$1, getImageMetadata, isGifMedia as isGifMedia$1, isTelegramVoiceCompatibleAudio, kindFromMime as kindFromMime$1, normalizePollInput } from "openclaw/plugin-sdk/media-runtime";
...
function resolveTelegramApiContext(opts) {
	const cfg = opts.cfg ?? loadConfig$1();
...
//#endregion
export { wasSentByBot as _, editMessageTelegram as a, withTelegramApiErrorLogging as b, renameForumTopicTelegram as c, sendStickerTelegram as d, sendTypingTelegram as f, recordSentMessage as g, resolveTelegramVoiceSend as h, editMessageReplyMarkupTelegram as i, sendMessageTelegram as l, unpinMessageTelegram as m, deleteMessageTelegram as n, pinMessageTelegram as o, send_exports as p, editForumTopicTelegram as r, reactMessageTelegram as s, createForumTopicTelegram as t, sendPollTelegram as u, buildInlineKeyboard as v, splitTelegramCaption as y };

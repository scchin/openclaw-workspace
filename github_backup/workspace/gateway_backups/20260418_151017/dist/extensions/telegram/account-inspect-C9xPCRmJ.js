import { c as resolveTelegramAccountConfig, i as mergeTelegramAccountConfig, o as resolveDefaultTelegramAccountId } from "./accounts-CoskdHdZ.js";
...
function inspectTelegramAccountPrimary(params) {
	...
	const envToken = accountId === DEFAULT_ACCOUNT_ID$1 ? normalizeOptionalString(params.envToken) ?? normalizeOptionalString(process.env.TELEGRAM_BOT_TOKEN) ?? "" : "";
	if (envToken) return {
		accountId,
		enabled,
		name: normalizeOptionalString(merged.name),

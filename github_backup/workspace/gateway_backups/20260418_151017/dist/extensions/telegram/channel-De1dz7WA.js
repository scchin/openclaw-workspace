import { d as resolveTelegramToken, s as resolveTelegramAccount } from "./accounts-CoskdHdZ.js";
import { n as parseTelegramReplyToMessageId, o as normalizeTelegramLookupTarget, r as parseTelegramThreadId, s as parseTelegramTarget } from "./outbound-params-DPqRaEDE.js";
import { i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as lookupTelegramChatId, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-B0aXBwuj.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-zDRhkQx3.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt } from "./exec-approvals-GJ9TaLpO.js";
import { t as telegramApprovalCapability } from "./approval-native-9xNAH8CY.js";
import { c as collectTelegramUnmentionedGroupIds, i as buildTelegramExecApprovalPendingPayload, o as telegramMessageActions$1, r as monitorTelegramProvider, s as auditTelegramGroupMembership, t as probeTelegram } from "./probe-D65JnxXS.js";
import { g as buildTelegramGroupPeerId, r as markdownToTelegramHtmlChunks } from "./format-DkmJkZf4.js";
...
import { t as resolveTelegramInlineButtons } from "./button-types-Z-Vei7zU.js";
import { t as resolveTelegramReactionLevel } from "./reaction-level-DTOtJXm8.js";
...
import { i as telegramSetupAdapter, n as detectTelegramLegacyStateMigrations, r as telegramSetupWizard } from "./channel.setup-Bei3ZTCY.js";
import { a as setTelegramThreadBindingMaxAgeBySessionKey, i as setTelegramThreadBindingIdleTimeoutBySessionKey, t as createTelegramThreadBindingManager } from "./thread-bindings-ComZmmvs.js";
...
import { createAllowlistProviderRouteAllowlistWarningCollector, resolveChannelGroupRequireMention, resolveChannelGroupToolsPolicy } from "openclaw/plugin-sdk/channel-policy";
...
async function loadTelegramSendModule$1() {
	telegramSendModulePromise$1 ??= import("./send-DlzbQJQs.js").then((n) => n.p);
...
async function loadTelegramSendModule() {
	telegramSendModulePromise ??= import("./send-DlzbQJQs.js").then((n) => n.p);
	...
	base: {
		...
		gateway: {
			...
			logoutAccount: async ({ accountId, cfg }) => {
				...
				let changed = false;
				if (nextTelegram) {
					if (accountId === DEFAULT_ACCOUNT_ID$1 && nextTelegram.botToken) {

import { n as listEnabledTelegramAccounts, s as resolveTelegramAccount, t as createTelegramActionGate, u as resolveTelegramPollActionGateState } from "./accounts-CoskdHdZ.js";
import { a as makeProxyFetch, n as resolveTelegramFetch, r as resolveTelegramTransport, t as resolveTelegramApiBase } from "./fetch-B2K4ajFP.js";
import { t as isTelegramInlineButtonsEnabled } from "./inline-buttons-zDRhkQx3.js";
import { a as isTelegramExecApprovalHandlerConfigured, i as isTelegramExecApprovalClientEnabled } from "./exec-approvals-GJ9TaLpO.js";
import { s as isRecoverableTelegramNetworkError, u as isTelegramPollingNetworkError } from "./format-DkmJkZf4.js";
...
import { createMessageToolButtonsSchema, createUnionActionGate, listTokenSourcedAccounts, resolveReactionMessageId } from "openclaw/plugin-sdk/channel-actions";
...
function loadAuditMembershipRuntime() {
	auditMembershipRuntimePromise ??= import("./audit-membership-runtime-DKXQfiQr.js");
...
async function loadTelegramActionRuntime() {
	telegramActionRuntimePromise ??= import("./action-runtime-yOxwsViu.js");
...
async function loadTelegramMonitorPollingRuntime() {
	telegramMonitorPollingRuntimePromise ??= import("./monitor-polling.runtime-eDxUeolT.js");
...
async function loadTelegramMonitorWebhookRuntime() {
	telegramMonitorWebhookRuntimePromise ??= import("./monitor-webhook.runtime-37ohYcS9.js");

...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-Dvv9VRAc.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-CeL3gSMO.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-Cma03vGs.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-BcrCYHRC.js";
...
import { H as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-DqhUu-iS.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-uuk3pOYm.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-CLnWA2Sk.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-e8pcLAoJ.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BgM_mWiF.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-HgYcNhu1.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-BVShKaZ4.js"),
		import("./probe-auth-CsetYcgO.js"),
		import("./probe-DCsktpkl.js")

...
import "./daemon-runtime-CniEQXCk.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-CeL3gSMO.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-B-FfdZ4h.js";
import { c as resolveManifestProviderOnboardAuthFlags, i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BRqkvYvj.js";
import { t as runSetupWizard } from "./setup-C-q0qjkR.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-B5DtxcXq.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-Clo5QSLj.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BcwY20Tj.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DlR__xlB.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-UcGDxwQF.js");

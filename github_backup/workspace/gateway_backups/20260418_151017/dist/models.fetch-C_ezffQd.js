...
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-BAYoD3Pu.js";
import { l as isKnownEnvApiKeyMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-ve-OgG6R.js";
...
import { c as SELF_HOSTED_DEFAULT_COST, l as SELF_HOSTED_DEFAULT_MAX_TOKENS } from "./provider-self-hosted-setup-7ndHtLKG.js";
...
async function resolveLmstudioRuntimeApiKey(params) {
	...
	if (isNonSecretApiKeyMarker(resolvedApiKey) && resolvedApiKey !== "custom-local") return await resolveConfiguredApiKeyOrThrow();

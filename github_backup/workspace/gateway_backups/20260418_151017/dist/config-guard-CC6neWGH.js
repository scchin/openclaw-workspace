import { F as shouldMigrateStateFromPath } from "./logger-D8OnBgBc.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-BeUSfQdm.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-CeLmGEcv.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-C3bUevJd.js"),
		import("./utils-DXVJ-7N9.js"),
		import("./command-format-BXnM9_h8.js")
	]);
	const rich = isRich();

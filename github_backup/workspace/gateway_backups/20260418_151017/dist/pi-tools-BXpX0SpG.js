...
import { d as resolveGatewayMessageChannel } from "./message-channel-CBqCPFa_.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, g as EXEC_TOOL_DISPLAY_SUMMARY, i as collectExplicitAllowlist, n as applyOwnerOnlyToolPolicy, o as mergeAlsoAllowPolicy, u as resolveToolProfilePolicy } from "./tool-policy-C3rJHw58.js";
import { i as listChannelAgentTools, l as copyPluginToolMeta, t as copyChannelAgentToolMeta, u as getPluginToolMeta } from "./channel-tools-DdZyHuyK.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-D6i9LZcG.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-D43D41q6.js";
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-DNojyvM5.js";
import { t as bindAbortRelay } from "./fetch-timeout-DZD6CQL_.js";
import { c as createHostWorkspaceEditTool, d as createSandboxedEditTool, f as createSandboxedReadTool, g as wrapToolWorkspaceRootGuardWithOptions, h as wrapToolWorkspaceRootGuard, l as createHostWorkspaceWriteTool, m as wrapToolMemoryFlushAppendOnlyWrite, p as createSandboxedWriteTool, t as createOpenClawTools, u as createOpenClawReadTool } from "./openclaw-tools-CUmYpN1l.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-C0me_HAs.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-BO46C_Es.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-B7mHodgb.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Bfwx2wkV.js";
import { n as assertSandboxPath } from "./sandbox-paths-C5p25GeS.js";
import { c as resolveWorkspaceRoot, i as resolveGroupToolPolicy, l as resolvePathFromInput, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy, u as toRelativeSandboxPath } from "./read-capability-KJ3-uRH6.js";
...
import { t as isToolAllowedByPolicies } from "./tool-policy-match-Cu6gJ6QQ.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-BrPriMlc.js";
...
function createLazyExecTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createExecTool } = await import("./bash-tools-DV3tXtMN.js");
...
function createLazyProcessTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createProcessTool } = await import("./bash-tools-DV3tXtMN.js");

...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-BAdwyfxI.js";
import { t as killProcessTree } from "./kill-tree-C8M_XC4G.js";
import { n as getShellConfig } from "./shell-utils-7dy62Zl_.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-Clm6RSB3.js");

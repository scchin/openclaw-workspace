...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-xm3f27dv.js";
import { a as loadConfig } from "./io-5pxHCi7V.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, x as parseAgentSessionKey } from "./session-key-Bh1lMwK5.js";
...
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-Delpa74L.js";
import "./defaults-CiQa3xnX.js";
import { i as applyMergePatch } from "./schema-validator-Byqt0Q69.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-hhTlRYqM.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, h as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-KFH9bkHi.js";
import "./config-Q9XZc_2I.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CBqCPFa_.js";
import "./message-channel-core-BIZsQ6dr.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-BIw3ISWS.js";
import { b as resetRegisteredAgentHarnessSessions } from "./loader-DYW2PvbF.js";
...
import { m as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-BB1a2aCy.js";
import { c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint } from "./thinking.shared-CAbk7EZs.js";
import { m as resolveModelRefFromString } from "./model-selection-CTdyYoio.js";
import { S as resolveGroupSessionKey, a as resolveSessionStoreEntry, c as updateSessionStore, m as resolveMaintenanceConfigFromInput, v as deriveSessionMetaPatch } from "./store-DFXcceZJ.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CZMxg3hs.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-KCfeTvaK.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-EClQPjt-.js";
...
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-BLDIg9zn.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CKM4Lddu.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-C3rJHw58.js";
...
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-vusm-AE2.js";
...
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-v58z7z2I.js";
...
import { t as resolveQueueSettings } from "./settings-runtime-CgE29DNS.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BG-J_PnY.js";
...
import { t as normalizeInboundTextNewlines } from "./inbound-text-Mk2PQPNo.js";
import { t as finalizeInboundContext } from "./inbound-context-3c7B1YUQ.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-B1SOAhzt.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DXpYnKaK.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-ClONjNhB.js";
...
import { n as resolveBlockStreamingChunking } from "./block-streaming-YtBpcaVq.js";
import { t as resolveCommandAuthorization } from "./command-auth-C4VasUjw.js";
import { t as buildCommandContext } from "./commands-context-v7HiTv6d.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DA7dFuNT.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-BUxj5f-5.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-nbFzbjGB.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CLUBV9OI.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-0ZGm8VdG.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-DcNmVk1f.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-D8ngkWKO.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-BOgGyfmJ.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-e5m21yqH.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-DsfmfEXD.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-D6ShskBH.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-OncwBx2w.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-XUaMaVxD.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-C07TR9i-.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-DVYDlpEA.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-3_wHYu8f.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-3_wHYu8f.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-C3u1Zw03.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-Dgt-SEBN.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-BqzyrOiX.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-BqzyrOiX.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-Cz_llyv3.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-d2CK3OpT.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-CTlghBhJ.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-Dq0XJhdf.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-wc_Kzeog.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-BckiZHtD.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-ChtZkJ0T.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-DURIkzFY.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-BdOpIhxP.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-CxGU7z77.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-DEfGTIg9.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-C9pFx-Xw.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-C_jbTWFV.js");

...
export declare function buildTelegramNativeCommandCallbackData(commandText: string): string;
export declare function parseTelegramNativeCommandCallbackData(data?: string | null): string | null;
export declare function resolveTelegramNativeCommandDisableBlockStreaming(telegramCfg: TelegramAccountConfig): boolean | undefined;

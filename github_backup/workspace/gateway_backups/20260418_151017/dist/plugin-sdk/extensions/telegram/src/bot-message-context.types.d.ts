...
export type TelegramMessageContextRuntimeOverrides = Partial<Pick<typeof import("./bot-message-context.runtime.js"), "createStatusReactionController" | "ensureConfiguredBindingRouteReady" | "loadConfig" | "recordChannelActivity">>;
export type TelegramMessageContextSessionRuntimeOverrides = Partial<Pick<typeof import("./bot-message-context.session.runtime.js"), "finalizeInboundContext" | "readSessionUpdatedAt" | "recordInboundSession" | "resolveInboundLastRouteSessionKey" | "resolvePinnedMainDmOwnerFromAllowlist" | "resolveStorePath">>;

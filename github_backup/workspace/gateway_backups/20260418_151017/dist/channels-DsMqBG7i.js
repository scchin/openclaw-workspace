...
import { t as danger } from "./globals-De6QTwLG.js";
...
import { u as isChannelVisibleInConfiguredLists } from "./registry-CENZffQG.js";
...
import { i as loadAuthProfileStore } from "./store-C1I9Mkh8.js";
import "./plugins-D4ODSIPT.js";
import "./logging-DW_bR-rY.js";
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-BTz8VrH1.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-D33sU6YZ.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-NxWLbAbV.js";
...
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DXlFJrtW.js";
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-oBu2dhSm.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-D86GhU57.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-DZDl9vtb.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Da-vVVwm.js";
import { t as parseLogLine } from "./parse-log-line-D6aNE7rv.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-u5jsIf1e.js";
import { n as createChannelOnboardingPostWriteHookCollector, o as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks } from "./onboard-channels-1Gt3BtRG.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-AcSOTgmf.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BTVRNoOc.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-Bdo4AQWB.js"), import("./onboard-channels-Cfjf3B6_.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CMYtzeTO.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CMYtzeTO.js");
			const prompter = createClackPrompter();

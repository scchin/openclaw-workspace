...
import { n as resolveAgentEffectiveModelPrimary, y as resolveAgentDir } from "./agent-scope-KFH9bkHi.js";
import { h as splitTrailingAuthProfile } from "./model-selection-cli-_3Gn8Wcd.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-CTdyYoio.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-KKLbMBGv.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-4lekVV0W.js");

...
import { s as hasOutboundReplyContent } from "./reply-payload-Db_8BQiX.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-1Aycu5Cc.js";
...
import { r as prefixSystemMessage } from "./system-message-ChJIYBoS.js";
import { i as toAcpRuntimeError } from "./errors-DrSVrMCJ.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-DHNnkP76.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-CHNuDmRE.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-YtBpcaVq.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-BWMox--C.js";
import { r as resolveAcpThreadSessionDetailLines } from "./session-identifiers-B8aS2nlu.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-B6X6N9nt.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-C2R8PCWN.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-CnLrsDs-.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-DDX6zF4d.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-CtZkM_ph.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-CLnWA2Sk.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-nYZ2wY7r.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-DvAVqe6g.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-DLScakoS.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-CtZkM_ph.js");

...
class Packer:
    ...
    def __init__(self, backup_root=None):
        ...
        self.modes = {
            ...
            "full": ["config", "memory", "workspace", "skills", "canvas", "browser_profile", "lockfiles"]
        }
        self.targets = {
            "config": [
    ...
    def estimate_size(self, mode="core"):
        ...
        chunk_size = 20 * 1024 * 1024 # Reduced to 20MB to comply with GitHub Content API (25MB limit)
    ...
    def pack(self, mode="core", destination_dir=None, encrypt=False, password=None):
        ...
        try:
            ...
            for key in target_keys:
                ...
                if not paths: continue
                if key == "lockfiles":
                    all_targets.extend(self._get_all_lockfiles())
                elif isinstance(paths, list):
                    all_targets.extend(paths)
    ...
    def chunk_archive(self, archive_path, chunk_size_mb=20):
